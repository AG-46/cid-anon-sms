...
clear
echo -e "\e[4;31m CID !!! \e[0m"
echo -e "\e[1;32m Presents \e[0m"
echo -e "\e[1;34m"
figlet -f slant cid-anon-sms
echo "Press Enter To Launch"
read a1
if [[ -s update.cid ]];then
...
gem install lolcat
echo This Tool Is Created By CID
echo This Script Is Created By CID >update.pandahackers
...
clear
echo -e "\e[1;31m"
figlet -f slant cid-anon-sms | lolcat
echo -e "\e[1;34m Created By \e[1;32m"  #blue color
toilet -f mono12 -F border PH | lolcat
echo -e "\e[4;34mThis Tool Is Created By CID \e[0m" #underline+blue
echo -e "\e[1;34mFor Any Queries Mail Us!!!\e[0m"
echo -e "\e[1;32m        Mail: hellopio900223@gmail.com \e[0m" #yellow
echo -e "\e[4;32mYouTube Page: https://youtube.com \e[0m" #green
echo -e "\e[1;34m    Telegram: https://t.me/ \e[0m"
echo " "
echo -e "\e[4;31mRead Instruction Carefully !!! \e[0m" #red
echo " "
echo "Enter 1 To  Run cid-anon-sms "
echo "Enter 2 To  Track cid-anon-sms "  #white
...
clear
echo -e "\e[1;32m"
echo 'Track cid-anon-sms'> call.xxx
...
if [[ -s cid-anon-sms/Run.sh ]];then
cd cid-anon-sms
cp -r -f * .. > temp
cd ..
rm -rf  cid-anon-sms >> temp
rm update.CID >> temp
rm temp
chmod +x Run.sh
fi
echo -e "\e[1;32m cid-anon-sms Will Refresh Now..."
...
echo -e "\e[1;32m        Mail: @gmail.com \e[0m"
echo -e "\e[1;32m   Instagram: https://Instagram.com \e[0m"
echo -e "\e[4;32mYouTube Page: https://www.youtube.com \e[0m"
...
toilet -f pagga -F border CID | lolcat
echo -e "\e[1;34m For Any Queries Mail Us!!!\e[0m"
echo -e "\e[1;32m        Mail: @gmail.com \e[0m"
