...
function banner() {
   ...
   echo -e "$Green   Welcome to cid-anon-sms $NC"
   echo -e "$Green     With cid-anon-sms You can send, Anonymous Text Message $NC"
   sleep 1
...
function byemsg() {
   ...
   sleep 1
   echo -e "$Green Closing cid-anon-sms... $NC"
   sleep 1
   echo " "
...
function VERSION() {
   echo " "
   echo -e "$BGreen cid-anon-sms version: v1.4(Non-Supported)"
   echo " "
}
